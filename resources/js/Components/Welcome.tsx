...
export default function Welcome() {
  return (
    <div>
      <div className="p-6 lg:p-8 bg-card dark:bg-linear-to-bl dark:from-gray-700/50 dark:via-transparent border-b border-border">
        <ApplicationLogo className="block h-12 w-auto" />

        <h1 className="mt-8 text-2xl font-medium text-foreground dark:text-white">
      ...
      <div className="bg-gray-200 bg-card bg-opacity-25 grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 p-6 lg:p-8">
        <div>
          <div className="flex items-center">
            ...
            <h2 className="ml-3 text-xl font-semibold text-foreground dark:text-white">
